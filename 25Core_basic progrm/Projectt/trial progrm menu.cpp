...
contact:
    ...
    file << " " << name << " " << roll_no << " " << course << " " <<marks<<" "<<percentage<< "\n";
    file.close();
}
void student::display() // Display data of student
{
    ...
    {
        file >> name >> roll_no >> course >>marks>> percentage >> email_id >> contact_no ; //pata nhi kya ho rha
        while (!file.eof())
        {
            ...
            cout << "\t\t\tName: " << name << "\n"
				<<left<<setw(12) << "\t\t\tRoll No.: " << roll_no << "\n";
            cout << "\t\t\tCourse: " << course << "\n";
            cout << "\t\t\tEmail Id: " << email_id << "\n";
            cout << "\t\t\tContact No.: " << contact_no << "\n";
            cout << "\t\t\tAddress: " << address << "\n";
            
            file >> name >> roll_no >> course >>marks>>percentage>>email_id >> contact_no >> address;
        }
        if (total == 0)
        {
